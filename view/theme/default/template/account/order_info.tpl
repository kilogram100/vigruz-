  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered table-hover">
        <thead>
          <tr>
            <td class="text-left" colspan="3"><?php echo $text_order_detail; ?></td>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td class="text-left"><?php if ($payment_method) { ?>
              ...
              <?php } ?></td>
  <?php if ($invoice_file) { ?>
            <th class="text-left" colspan="2"><a href="<?php echo $invoice_file; ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Скачать"><i class="fa fa-cloud-download"> счет</i></a></th>
  <?php } ?>
          </tr>
        </tbody>
      </table>
