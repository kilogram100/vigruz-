...
$_['text_checkout_option_original']  = 'Шаг 1: Способ оформления заказа';
$_['text_checkout_option']		     = 'Три шага для оформления заказа';
$_['text_checkout_account']          = 'Шаг 2: Профиль &amp; Платежная информация';
$_['text_checkout_payment_address_original']  = 'Шаг 2: Платежная информация';
...
$_['text_checkout_payment_method_original']   = 'Шаг 5: Способ оплаты';
$_['text_checkout_payment_method']   = 'Шаг 2: Способ оплаты';
$_['text_checkout_confirm_original'] = 'Шаг 6: Подтверждение заказа';
$_['text_checkout_confirm']          = 'Шаг 3: Подтверждение заказа';
