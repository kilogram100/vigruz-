...
class ControllerInformationSitemap extends Controller {
	...
	$data['OldSite_TopCategory'] = array();
	$categories_1 = $this->model_catalog_category->getOldSiteTopCategory( 20 );

        foreach ($categories_1 as $category_1) {
            $level_2_data = array();

            $categories_2 = $this->model_catalog_category->getOldSiteTopCategory($category_1['id']);

            foreach ($categories_2 as $category_2) {
                $level_3_data = array();

                $categories_3 = $this->model_catalog_category->getOldSiteTopCategory($category_2['id']);

                foreach ($categories_3 as $category_3) {
                    $level_3_data[] = array(
                        'name' => $category_3['name'],
                        'href' => $category_3['alias'] . '/'
                    );
                }
